...
const messages = {
  "zh-CN": {
    ...
    taskTokenBudget: "单任务预算",
    cost: "费用",
    budget: "预算",
    tokens: "Token",
    unlimited: "不限",
    costHint: "累计模型调用费用；按服务端当前价格配置计算。",
    taskBudgetHint: "任务累计输入与输出 Token；达到预算后会自动停止模型循环。",
    globalUsageHint: "所有可见会话本月累计费用。",
    pricingHint: "价格单位为美元 / 1,000,000 Token；缓存命中价格仅用于命中的输入 Token。",
    pricingShort: "入 {{input}} · 缓存 {{cached}} · 出 {{output}} / M",
    noTaskTitle: "还没有会话",
  ...
  en: {
    ...
    usageSummary: "Usage & billing",
    monthCost: "Month cost",
    monthTokens: "Month tokens",
    taskTokenBudget: "Task budget",
    cost: "Cost",
    budget: "Budget",
    tokens: "tokens",
    unlimited: "Unlimited",
    costHint: "Cumulative model-call cost using the server's current pricing configuration.",
    taskBudgetHint: "Cumulative input and output tokens; the model loop stops when this budget is reached.",
    globalUsageHint: "Cumulative cost for all visible sessions this month.",
    pricingHint: "Prices are USD per 1,000,000 tokens; cached pricing applies only to cached input tokens.",
    pricingShort: "in {{input}} · cache {{cached}} · out {{output}} / M",
